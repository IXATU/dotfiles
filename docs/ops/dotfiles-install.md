...
- **MesloLGS NF:** `make install-fonts` instala solo fuentes user-level de Linux/WSL, respeta `DRY_RUN=1`, usa `fc-cache -fv` sobre el directorio concreto y no toca configuración del host Windows.

...
Related: [AGENT_FIRST_SUMMARY.md](AGENT_FIRST_SUMMARY.md), [AGENT_WORKFLOW.md](AGENT_WORKFLOW.md), [OPERATIONS_CHEATSHEET.md](OPERATIONS_CHEATSHEET.md), [VALIDATION_MATRIX.md](VALIDATION_MATRIX.md).
